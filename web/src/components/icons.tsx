...
export const LogosOpensource = ({ size = 24, width, height, ...props }: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size || width}
...
export const ExperimentIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size || width}
    height={size || height}
...
export const InfoIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    width={size || width}
    height={size || height}
    viewBox="0 0 24 24"
...
export const DeleteIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M7.615 20q-.69 0-1.152-.462T6 18.385V6H5V5h4v-.77h6V5h4v1h-1v12.385q0 .69-.462 1.152T16.385 20zm2.193-3h1V8h-1zm3.384 0h1V8h-1z" />
  </svg>
)
